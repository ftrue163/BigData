package com.sunjincheng.no27_topology;


import com.sunjincheng.no27_topology.functions.SideOutputProcessFunction;
import com.sunjincheng.no27_topology.functions.SimpleSourceFunction;
import com.sunjincheng.no27_topology.functions.StateProcessFunction;
...
//        version4(env);
    ...
    /**
     * 第三个业务版本
     * uid方法的使用及作用：在作业升级后并进行重新运行时能起到作用
     */
