 ...
 *      (key, 9, 2020-06-29 09:55:52.295)
 *
 *      2. 将Time.of(2, TimeUnit.SECONDS)，变成 Time.of(3, TimeUnit.SECONDS) 观察昨天重启时间变化
 *      (key, 9, 2020-06-29 09:55:55.277)
 *      09:55:55,382 ERROR restart.NoRestartJob - Bad data [10] ...
 *      (key, 9, 2020-06-29 09:55:58.41)
 * <p>
 * 作者：张智奇
 * 日期：2021/01/08
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        source.map(new MapFunction<Tuple3<String, Integer, Long>, Tuple3<String, Integer, String>>() {
            ...
            public Tuple3<String, Integer, String> map(Tuple3<String, Integer, Long> value) throws Exception {
                ...
                return new Tuple3<>(value.f0, value.f1, new Timestamp(System.currentTimeMillis()).toString());
            }
        }).print();
