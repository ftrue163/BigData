...
public class Flink07_CEP_Loop_Greedy {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WaterSensor> waterSensorDStream = env.readTextFile("flink/input/sensor2.txt")
        ...
        Pattern<WaterSensor, WaterSensor> pattern = Pattern
                ...
                .times(2, 3)
                //.timesOrMore(2)
                //贪婪  后面还有模式(比如 next )时 才起作用  否则没有变化
                .greedy()
                .next("end")
                .where(new IterativeCondition<WaterSensor>() {
                    @Override
