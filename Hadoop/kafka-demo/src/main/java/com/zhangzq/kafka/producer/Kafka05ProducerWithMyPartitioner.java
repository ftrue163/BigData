 ...
 */
public class Kafka05ProducerWithMyPartitioner {
    public static void main(String[] args) throws InterruptedException {
        ...
        // 添加自定义分区器
        props.put(ProducerConfig.PARTITIONER_CLASS_CONFIG, "com.zhangzq.kafka.producer.partitioner.CustomPartitioner");
        ...
        // 4. 调用send方法发送消息
        for (int i = 0; i < 100; i++) {
            myKafkaProducer.send(new ProducerRecord<String, String>("second", "helloworld" + i), new Callback() {
                @Override
