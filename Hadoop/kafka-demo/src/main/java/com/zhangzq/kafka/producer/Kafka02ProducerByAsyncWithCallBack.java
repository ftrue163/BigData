 ...
 */
public class Kafka02ProducerByAsyncWithCallBack {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            ProducerRecord<String, String> producerRecord = new ProducerRecord<>("second", "helloworld-" + i);
            ...
            kafkaProducer.send(producerRecord, new Callback() {
                ...
                public void onCompletion(RecordMetadata metadata, Exception exception) {
                    if (exception != null) {
                        ...
                        // 没有异常，输出信息到控制台
                        System.out.printf("offset = %s, partition = %s, topic = %s, value = %s\n", metadata.offset(), metadata.partition(), metadata.topic(), producerRecord.value());
                    }
                }
            });
